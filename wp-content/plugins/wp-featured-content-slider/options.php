	    ...
	    <div class="inside">
		    <table class="form-table">
			    ...
			    <tr>
				    ...
				    <td><input type="text" name="limit" value="<?php $limit = get_option('limit'); if(!empty($limit)) { echo $limit; } else { echo "350"; } ?>"></td>
			    </tr>
			    <tr>
				    <th><label for="points">More Seperator</label></th>
				    <td><input type="text" name="points" value="<?php $points = get_option('points'); if(!empty($points)) { echo $points; } else { echo "..."; } ?>"></td>
			    </tr>
			    <tr>
				    <th><label for="limit_posts">Limit Number of Posts (0 = unlimited)</label></th>
				    <td><input type="text" name="limit_posts" value="<?php $limit_posts = get_option('limit_posts'); if(!empty($limit_posts)) { echo $limit_posts; } else { echo "0"; } ?>"></td>
			    </tr>
			    <tr>
