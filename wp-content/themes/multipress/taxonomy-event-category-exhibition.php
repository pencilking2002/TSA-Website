			...
			<div class="b_text">
				...
				<span class="dynamic-settings-style-single-post_text">
					...
					<div class="cosmo-tabs default has_title" id="53">
						...
						<?php query_posts('event-type=upcoming&event-category=exhibition'); ?><!--Only get posts in the 'upcoming' taxonomy-->
						...
						<div class="tabs-container" id="t977">
							...
							<?php query_posts('event-type=past&event-category=exhibition'); ?><!--Only get posts in the 'past' taxonomy-->
